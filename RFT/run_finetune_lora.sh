...
cd /lustre/home/pnazari/workspace/CompreSSM2
...
COMPRESSED_CHECKPOINT="/fast/pnazari/flame/dump/${MODEL_NAME}/${PARAMS}/${TOKENS}/checkpoints/${METHOD}_compressed_${RANK}/step-0"

# Path to save finetuned model (output)
FINETUNED_OUTPUT_DIR="/fast/pnazari/flame/dump/${MODEL_NAME}/${PARAMS}/${TOKENS}/checkpoints/long_${METHOD}_finetuned_${RANK}"
...
if [[ "$PARAMS" == "340m" ]]; then
    ...
    TEACHER_DIR="/fast/pnazari/flame/dump/${MODEL_NAME}/${PARAMS}/${TOKENS}/checkpoints"
